...
Уведомления доставляются best effort: события находятся в памяти процесса, постоянной очереди и повторных попыток нет. Ошибка Telegram-сервиса не откатывает подтверждённый результат смены.
